module.exports = (schedule, Day, User, Workout, Gym) => {
  ...
  // schedule(Day.Wednesday, "06", "30", User.X, Workout.Bodypump, Gym.Lilla_Torg);
  // schedule(Day.Wednesday, "18", "15", User.X, Workout.Bodypump, Gym.Dalaplan);
  ...
  // schedule(Day.Thursday, "18", "00", User.X, Workout.Bodypump, Gym.Katrinelund);
  // schedule(Day.Thursday, "19", "00", User.X, Workout.Bodypump, Gym.Lilla_Torg);
  schedule(Day.Thursday, "18", "00", User.CS, Workout.Bodypump, Gym.Dalaplan);


  // schedule(Day.Saturday, "10", "00", User.X, Workout.Bodypump, Gym.Lilla_Torg);
  // schedule(Day.Saturday, "10", "00", User.X, Workout.Bodypump, Gym.Lilla_Torg);
